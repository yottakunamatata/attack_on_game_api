...
class EventService {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!eventDTO.isPublish) {
        throw new CustomError_1.CustomError(
          CustomResponseType_1.CustomResponseType.UNAUTHORIZED,
          EventResponseType_1.EventResponseType.FAILED_AUTHORIZATION,
        );
      }
  ...
  getAll(queryParams) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return lodash_1.default.map(eventData, (event) =>
        new eventDTO_1.EventDTO(event).toDetailDTO(),
      );
    });
  }
  create(content) {
  ...
  update(id, content) {
    return __awaiter(this, void 0, void 0, function* () {
      const updateContent = Object.assign(Object.assign({}, content), {
        idNumber: id,
      });
  ...
  getEventsForStore(storeId, optionsReq) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const eventData = yield this.eventRepository.getEventsByStoreId(
        storeId,
        queryParams,
      );
      if (!lodash_1.default.isEmpty(eventData)) {
        const eventDTOs = lodash_1.default.map(eventData, (event) =>
          new eventDTO_1.EventDTO(event).toDetailDTO(),
        );
        return eventDTOs;
      }
