...
class OrderService {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!eventId) {
        throw new CustomError_1.CustomError(
          CustomResponseType_1.CustomResponseType.VALIDATION_ERROR,
          OrderResponseType_1.OrderResponseType.FAILED_VALIDATION_EVENT_ID,
        );
      }
      ...
      const targetTicketsDTO = ticketList.map((ticket) =>
        new ticketDTO_1.TicketDTO(ticket).toDetailDTO(),
      );
      return {
        event: targetEventDTO.toSummaryDTO(),
        order: targetOrderDTO.toDetailDTO(),
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (lodash_1.default.isEmpty(player)) {
        throw new CustomError_1.CustomError(
          ...
          OrderResponseType_1.OrderResponseType.ERROR_PLAYER_FOUND,
        );
      }
      return player;
    });
  ...
  findEventByDbId(eventId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (lodash_1.default.isEmpty(event)) {
        throw new CustomError_1.CustomError(
          CustomResponseType_1.CustomResponseType.NOT_FOUND,
          EventResponseType_1.EventResponseType.FAILED_FOUND,
        );
      }
      return event;
    });
  ...
  findTickets(orderId, userId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (lodash_1.default.isEmpty(ticketList)) {
        throw new CustomError_1.CustomError(
          CustomResponseType_1.CustomResponseType.NOT_FOUND,
          TicketResponseType_1.TicketResponseType.FAILED_FOUND,
        );
      }
      return ticketList;
    });
  ...
  createOrderDTO(body, event, player) {
    return new orderDTO_1.OrderDTO(
  ...
  validateOrder(event, orderDTO) {
    ...
    if (!targetEventDTO.isRegisterable) {
      throw new CustomError_1.CustomError(
        CustomResponseType_1.CustomResponseType.VALIDATION_ERROR,
        OrderResponseType_1.OrderResponseType.CREATED_ERROR_REGISTRATION_PERIOD,
      );
    }
    if (
      ...
      throw new CustomError_1.CustomError(
        CustomResponseType_1.CustomResponseType.VALIDATION_ERROR,
        OrderResponseType_1.OrderResponseType.CREATED_ERROR_MONEY,
      );
    }
    if (targetEventDTO.availableSeat < orderDTO.registrationCount) {
      throw new CustomError_1.CustomError(
        CustomResponseType_1.CustomResponseType.VALIDATION_ERROR,
        OrderResponseType_1.OrderResponseType.CREATED_ERROR_EXCEEDS_CAPACITY,
      );
    }
  }
