...
class MyEventRouter extends baseRouter_1.BaseRouter {
  ...
  setRouters() {
    this.router.get(
      ...
      myEventValidator_1.EventValidator.validateEventQuery,
      handleValidationErrors_1.handleValidationErrors,
      this.handleRequest(this.controller.gatAll),
    );
    this.router.get(
      '/:eventId',
      auth_1.jwtAuthenticator,
      myEventValidator_1.EventValidator.validateEventParam(),
      handleValidationErrors_1.handleValidationErrors,
    ...
    this.router.patch(
      '/cancel-user',
      auth_1.jwtAuthenticator,
      myEventValidator_1.EventValidator.validateEventBody('playerId'),
      handleValidationErrors_1.handleValidationErrors,
    ...
    this.router.patch(
      '/cancel-event',
      auth_1.jwtAuthenticator,
      myEventValidator_1.EventValidator.validateEventBody('eventId'),
      handleValidationErrors_1.handleValidationErrors,
