...
class EventRouter extends baseRouter_1.BaseRouter {
  ...
  setRouters() {
    this.router.post(
      '/',
      eventValidator_1.EventValidator.validateEvent(),
      handleValidationErrors_1.handleValidationErrors,
      this.handleRequest(this.controller.create),
    );
    this.router.get(
      '/',
      eventValidator_1.EventValidator.validateEventQuery(),
      handleValidationErrors_1.handleValidationErrors,
    ...
    this.router.get(
      '/store/:storeId/',
      eventValidator_1.EventValidator.validateEventQuery(),
      eventValidator_1.EventValidator.validateEventParam('storeId'),
      handleValidationErrors_1.handleValidationErrors,
      this.handleRequest(this.controller.getEventsByStore),
    );
    this.router.get(
      '/:id',
      eventValidator_1.EventValidator.validateEventParam('id'),
      handleValidationErrors_1.handleValidationErrors,
