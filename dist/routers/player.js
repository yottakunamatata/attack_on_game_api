...
router.get('/:id', auth_1.jwtAuthenticator, playerValidator_1.updatePlayerValidator, player_1.getPlayer);
router.put('/:id', auth_1.jwtAuthenticator, player_1.updatePlayer);
