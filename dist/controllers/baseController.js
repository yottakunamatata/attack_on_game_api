...
class BaseController {
  constructor(msg) {
    this.handleServiceResponse = (serviceMethod, successMessage) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const result = yield serviceMethod();
          if (lodash_1.default.isBoolean(result)) {
            return this.formatResponse(
              CustomResponseType_1.CustomResponseType.SUCCESS,
              successMessage,
            );
            ...
            return this.formatResponse(
              CustomResponseType_1.CustomResponseType.OTHER,
              OtherResponseType_1.SPECIAL_ERROR_MSG,
            );
          }
        } catch (error) {
          if (this.isErrorCode(error)) {
            return this.formatResponse(
              error.code ||
                CustomResponseType_1.CustomResponseType.SYSTEM_ERROR,
              error.msg,
            );
          }
          return this.formatResponse(
  ...
  isErrorCode(error) {
    return error.code !== undefined && error.msg !== undefined;
  }
}
