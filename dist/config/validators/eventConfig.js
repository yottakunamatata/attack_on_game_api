...
const validateEventTimesOrder = (value, { req }) => {
  ...
  if (
    (0, dayjs_1.default)(registrationStartTime).isAfter(
      (0, dayjs_1.default)(registrationEndTime),
    )
  ) {
    throw new Error('註冊開始時間不能晚於註冊結束時間哦！');
  }
  if (
    (0, dayjs_1.default)(eventStartTime).isAfter(
      (0, dayjs_1.default)(eventEndTime),
    )
  ) {
    throw new Error('活動開始時間不能晚於活動結束時間哦！');
  }
  if (
    (0, dayjs_1.default)(registrationEndTime).isAfter(
      (0, dayjs_1.default)(eventStartTime),
    )
  ) {
...
exports.validationConfig = {
  body: {
    ...
    eventStartTime: [
      (0, express_validator_1.body)('eventStartTime')
        ...
        .custom((value, { req, location, path }) =>
          (0, commonConfig_1.isFutureDate)(value, { req, location, path }),
        )
        .custom((value, { req, location, path }) =>
          (0, commonConfig_1.isValidDateFormat)(value, { req, location, path }),
        ),
    ],
    eventEndTime: [
    ...
    minParticipants: [
      ...
      (0, express_validator_1.body)('minParticipants').custom(
        (value, { req }) => {
