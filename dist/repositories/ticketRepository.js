...
class TicketRepository {
  create(orderId, playerId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        handleDatabaseError(
          error,
          TicketResponseType_1.TicketResponseType.FAILED_CREATED,
        );
      }
    });
  }
  markQrCodeAsUsed(content) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        return yield TicketModel_1.default
          .findOneAndUpdate(
        ...
        handleDatabaseError(
          error,
          TicketResponseType_1.TicketResponseType.FAILED_UPDATE,
        );
      }
    });
  }
  ...
  generateQRCode(idNumber) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        throw new CustomError_1.CustomError(
          CustomResponseType_1.CustomResponseType.VALIDATION_ERROR,
          `${TicketResponseType_1.TicketResponseType.FAILED_CREATED}:${error.message || error}`,
        );
      }
    });
  }
