...
const isSameOrBefore_1 = __importDefault(
...
class EventDTO extends baseDTO_1.BaseDTO {
  constructor(dto) {
    ...
    super(dtoWithId);
    this._storeId =
      (_a = dto.storeId) !== null && _a !== void 0
        ? _a
        : new mongoose_1.Types.ObjectId();
    this._title = (_b = dto.title) !== null && _b !== void 0 ? _b : '';
    this._address = (_c = dto.address) !== null && _c !== void 0 ? _c : '';
    this._isFoodAllowed =
      (_d = dto.isFoodAllowed) !== null && _d !== void 0 ? _d : false;
    this._description =
      (_e = dto.description) !== null && _e !== void 0 ? _e : '';
    this._eventStartTime = dto.eventStartTime
      ? (0, dayjs_1.default)(dto.eventStartTime).format(
          TIME_FORMATTER_1.default,
        )
      : '';
    ...
    this._registrationStartTime = dto.registrationStartTime
      ? (0, dayjs_1.default)(dto.registrationStartTime).format(
          TIME_FORMATTER_1.default,
        )
      : '';
    this._registrationEndTime = dto.registrationEndTime
      ? (0, dayjs_1.default)(dto.registrationEndTime).format(
          TIME_FORMATTER_1.default,
        )
      : '';
    this._maxParticipants =
      (_f = dto.maxParticipants) !== null && _f !== void 0 ? _f : 0;
    this._minParticipants =
      (_g = dto.minParticipants) !== null && _g !== void 0 ? _g : 0;
    this._currentParticipantsCount =
      (_h = dto.currentParticipantsCount) !== null && _h !== void 0 ? _h : 0;
    this._participationFee =
      (_j = dto.participationFee) !== null && _j !== void 0 ? _j : 0;
    this._eventImageUrl =
      (_k = dto.eventImageUrl) !== null && _k !== void 0 ? _k : [''];
    this._isPublish =
      (_l = dto.isPublish) !== null && _l !== void 0 ? _l : true;
  }
  get isRegisterable() {
