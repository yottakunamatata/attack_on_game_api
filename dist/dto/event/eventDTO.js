...
class EventDTO extends baseDTO_1.BaseDTO {
  constructor(dto) {
    ...
    this._eventStartTime = (0, dayjs_1.default)(dto.eventStartTime).format(
      TIME_FORMATTER_1.default,
    );
    this._eventEndTime = (0, dayjs_1.default)(dto.eventEndTime).format(
      TIME_FORMATTER_1.default,
    );
    this._registrationStartTime = (0, dayjs_1.default)(
      dto.registrationStartTime,
    ).format(TIME_FORMATTER_1.default);
    this._registrationEndTime = (0, dayjs_1.default)(
